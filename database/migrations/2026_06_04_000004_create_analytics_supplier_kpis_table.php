...
return new class extends Migration
{
    ...
    {
        Schema::create('analytics_supplier_kpis', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['analytics_run_id', 'critical_products_count']);
        });
    }
    ...
    {
        Schema::dropIfExists('analytics_supplier_kpis');
    }
};
